...
public class z {
    ...
    public z(Plugin javaPlugin) {
        ...
        if (!(file = new File(file2, "anarchicznyhelmii.yml")).exists()) {
            try {
                file.createNewFile();
                yamlConfiguration = new YamlConfiguration();
                String string = "=== Konfiguracja przedmiotu 'Anarchiczny he\u0142m II' ===\nOpis: Plik konfiguracyjny okre\u015bla w\u0142a\u015bciwo\u015bci przedmiotu eventowego 'Anarchiczny he\u0142m II'.\n";
                yamlConfiguration.options().header(string);
                yamlConfiguration.options().copyHeader(true);
                yamlConfiguration.set("anarchicznyhelmii.material", (Object)"NETHERITE_HELMET");
                yamlConfiguration.set("anarchicznyhelmii.name", (Object)"&4Anarchiczny he\u0142m II");
                yamlConfiguration.set("anarchicznyhelmii.lore", (Object)new ArrayList());
                yamlConfiguration.set("anarchicznyhelmii.customModelData", (Object)1);
                yamlConfiguration.set("anarchicznyhelmii.enchantments", (Object)List.of((Object)"PROTECTION_ENVIRONMENTAL:6", (Object)"DURABILITY:6"));
                yamlConfiguration.set("anarchicznyhelmii.flags", (Object)List.of());
                yamlConfiguration.set("anarchicznyhelmii.unbreakable", (Object)false);
        ...
        this.A = yamlConfiguration.getConfigurationSection("anarchicznyhelmii");
    }

    public ItemStack A() {
        Material material;
        try {
            material = Material.valueOf((String)this.A.getString("material", "NETHERITE_HELMET"));
        }
        ...
        itemMeta.setDisplayName(me.anarchiacore.customitems.stormitemy.utils.color.A.C(this.A.getString("name", "&4Anarchiczny He\u0142m II")));

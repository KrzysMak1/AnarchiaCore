...
extends D {
    ...
    public void handleEffect(ItemStack itemStack, Object ... objectArray) {
        ...
        if (!(object22 = this.getAttackerChat().replace((CharSequence)"{TARGET}", (CharSequence)(entity instanceof Player ? ((Player)entity).getName() : "entity"))).isEmpty()) {
            player.sendMessage(me.anarchiacore.customitems.stormitemy.utils.color.A.C((String)object22));
        }
        ...
        if (!string.isEmpty() || !object.isEmpty()) {
            player.sendTitle(me.anarchiacore.customitems.stormitemy.utils.color.A.C(string), me.anarchiacore.customitems.stormitemy.utils.color.A.C((String)object), 10, 60, 20);
        }
        if (entity instanceof Player) {
            Player player2 = (Player)entity;
            String string2 = this.getTargetChat().replace((CharSequence)"{PLAYER}", (CharSequence)player.getName());
            if (!string2.isEmpty()) {
                player2.sendMessage(me.anarchiacore.customitems.stormitemy.utils.color.A.C(string2));
            }
            ...
            if (!string3.isEmpty() || !string4.isEmpty()) {
                player2.sendTitle(me.anarchiacore.customitems.stormitemy.utils.color.A.C(string3), me.anarchiacore.customitems.stormitemy.utils.color.A.C(string4), 10, 60, 20);
            }
        }
    }

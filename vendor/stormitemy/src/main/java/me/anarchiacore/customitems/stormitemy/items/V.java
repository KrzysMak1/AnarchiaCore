...
public class V {
    ...
    public V(Plugin javaPlugin) {
        ...
        if (!(file = new File(file2, "anarchicznespodnie.yml")).exists()) {
            try {
                file.createNewFile();
                yamlConfiguration = new YamlConfiguration();
                String string = "=== Konfiguracja przedmiotu 'Anarchiczne spodnie' ===\nOpis: Plik konfiguracyjny okre\u015bla w\u0142a\u015bciwo\u015bci przedmiotu eventowego 'Anarchiczne spodnie'.\n";
                yamlConfiguration.options().header(string);
                yamlConfiguration.options().copyHeader(true);
                yamlConfiguration.set("anarchicznespodnie.material", (Object)"NETHERITE_LEGGINGS");
                yamlConfiguration.set("anarchicznespodnie.name", (Object)"&4Anarchiczne spodnie");
                yamlConfiguration.set("anarchicznespodnie.lore", (Object)new ArrayList());
                yamlConfiguration.set("anarchicznespodnie.customModelData", (Object)0);
                yamlConfiguration.set("anarchicznespodnie.enchantments", (Object)List.of((Object)"PROTECTION_ENVIRONMENTAL:5", (Object)"DURABILITY:5"));
                yamlConfiguration.set("anarchicznespodnie.flags", (Object)List.of());
                yamlConfiguration.set("anarchicznespodnie.unbreakable", (Object)false);
        ...
        this.A = yamlConfiguration.getConfigurationSection("anarchicznespodnie");
    }
    ...
    public ItemStack A() {
        ...
        itemMeta.setDisplayName(me.anarchiacore.customitems.stormitemy.utils.color.A.C(this.A.getString("name", "&4Anarchiczne spodnie")));

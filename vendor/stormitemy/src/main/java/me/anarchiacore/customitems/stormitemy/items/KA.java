...
public class KA {
    ...
    public KA(Plugin javaPlugin) {
        ...
        if (!(file = new File(file2, "anarchiczna_klata_ii.yml")).exists()) {
            try {
                file.createNewFile();
                yamlConfiguration = new YamlConfiguration();
                String string = "=== Konfiguracja przedmiotu 'Anarchiczna klata II' ===\nOpis: Plik konfiguracyjny okre\u015bla w\u0142a\u015bciwo\u015bci przedmiotu eventowego 'Anarchiczna klata II'.\n";
                yamlConfiguration.options().header(string);
                yamlConfiguration.options().copyHeader(true);
                yamlConfiguration.set("anarchiczna_klata_ii.material", (Object)"NETHERITE_CHESTPLATE");
                yamlConfiguration.set("anarchiczna_klata_ii.name", (Object)"&4Anarchiczna klata II");
                yamlConfiguration.set("anarchiczna_klata_ii.lore", (Object)new ArrayList());
                yamlConfiguration.set("anarchiczna_klata_ii.customModelData", (Object)1);
                yamlConfiguration.set("anarchiczna_klata_ii.enchantments", (Object)List.of((Object)"PROTECTION_ENVIRONMENTAL:6", (Object)"DURABILITY:6"));
                yamlConfiguration.set("anarchiczna_klata_ii.flags", (Object)List.of());
                yamlConfiguration.set("anarchiczna_klata_ii.unbreakable", (Object)false);
        ...
        this.A = yamlConfiguration.getConfigurationSection("anarchiczna_klata_ii");
    }
    ...
    public ItemStack A() {
        ...
        itemMeta.setDisplayName(me.anarchiacore.customitems.stormitemy.utils.color.A.C(this.A.getString("name", "&4Anarchiczna klata II")));

...
public class RegionsEnteredEvent extends Event implements Cancellable
{
    ...
    public RegionsEnteredEvent(final UUID playerUUID, final Set<ProtectedRegion> regions) {
    ...
    public static HandlerList getHandlerList() {
        return RegionsEnteredEvent.handlers;
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof RegionsEnteredEvent)) {
            return false;
        }
        final RegionsEnteredEvent other = (RegionsEnteredEvent)o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof RegionsEnteredEvent;
    }
    ...
    public String toString() {
        return "RegionsEnteredEvent(cancelled=" + this.isCancelled() + ", uuid=" + String.valueOf((Object)this.getUuid()) + ", regions=" + String.valueOf((Object)this.getRegions()) + ", regionsNames=" + String.valueOf((Object)this.getRegionsNames());
    }

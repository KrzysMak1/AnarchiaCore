...
public class RegionLeftEvent extends Event implements Cancellable
{
    ...
    public RegionLeftEvent(final UUID playerUUID, final ProtectedRegion region) {
    ...
    public static HandlerList getHandlerList() {
        return RegionLeftEvent.handlers;
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof RegionLeftEvent)) {
            return false;
        }
        final RegionLeftEvent other = (RegionLeftEvent)o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof RegionLeftEvent;
    }
    ...
    public String toString() {
        return "RegionLeftEvent(cancelled=" + this.isCancelled() + ", uuid=" + String.valueOf((Object)this.getUuid()) + ", region=" + String.valueOf((Object)this.getRegion()) + ", regionName=" + this.getRegionName();
    }

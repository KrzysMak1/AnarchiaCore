...
final class ComponentCompaction
{
    ...
    static Component compact(@NotNull final Component self, @Nullable final Style parentStyle) {
        ...
        for (int i = 0; i < children.size(); ++i) {
            ...
            if (child2.children().isEmpty() && isText(child2)) {
        ...
        if (isText(optimized)) {
            while (!childrenToAppend.isEmpty()) {
                ...
                if (!isText(child3) || !Objects.equals((Object)childStyle, (Object)childParentStyle)) {
                    break;
                }
        ...
        while (i + 1 < childrenToAppend.size()) {
            ...
            if (child2.children().isEmpty() && isText(child2) && isText(neighbor)) {

package cc.dreamcode.antylogout.libs.net.kyori.adventure.audience;

import cc.dreamcode.antylogout.libs.net.kyori.adventure.dialog.DialogLike;
import java.util.Iterator;
import java.util.ArrayList;
import java.util.Collection;
import java.util.List;
import java.util.UUID;
import cc.dreamcode.antylogout.libs.net.kyori.adventure.resource.ResourcePackInfo;
import cc.dreamcode.antylogout.libs.net.kyori.adventure.resource.ResourcePackRequestLike;
import cc.dreamcode.antylogout.libs.net.kyori.adventure.resource.ResourcePackRequest;
import cc.dreamcode.antylogout.libs.net.kyori.adventure.resource.ResourcePackInfoLike;
import cc.dreamcode.antylogout.libs.net.kyori.adventure.inventory.Book;
import cc.dreamcode.antylogout.libs.net.kyori.adventure.sound.SoundStop;
import cc.dreamcode.antylogout.libs.net.kyori.adventure.sound.Sound;
import cc.dreamcode.antylogout.libs.net.kyori.adventure.bossbar.BossBar;
import cc.dreamcode.antylogout.libs.net.kyori.adventure.title.TitlePart;
import cc.dreamcode.antylogout.libs.net.kyori.adventure.title.Title;
import java.util.Objects;
import cc.dreamcode.antylogout.libs.net.kyori.adventure.chat.SignedMessage;
import cc.dreamcode.antylogout.libs.net.kyori.adventure.chat.ChatType;
import cc.dreamcode.antylogout.libs.net.kyori.adventure.identity.Identified;
import cc.dreamcode.antylogout.libs.net.kyori.adventure.identity.Identity;
...
import cc.dreamcode.antylogout.libs.net.kyori.adventure.pointer.Pointered;
...
public interface Audience extends Pointered
{
    ...
    default Audience audience(@NotNull final Audience... audiences) {
        ...
        return audience((Iterable<? extends Audience>)Arrays.asList((Object[])audiences));
    }
    ...
    default Audience filterAudience(@NotNull final Predicate<? super Audience> filter) {
        return filter.test((Object)this) ? this : empty();
    }

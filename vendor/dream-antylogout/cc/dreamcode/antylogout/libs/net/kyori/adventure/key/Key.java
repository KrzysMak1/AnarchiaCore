...
public interface Key extends Comparable<Key>, Examinable, Namespaced, Keyed
{
    ...
    @NotNull
    default Key key(@KeyPattern @NotNull final String string) {
        return key(string, ':');
    }
    
    @NotNull
    default Key key(@NotNull final String string, final char character) {
        Objects.requireNonNull((Object)string, "string");
    ...
    @NotNull
    default Key key(@NotNull final Namespaced namespaced, @KeyPattern.Value @NotNull final String value) {
        return key(((Namespaced)Objects.requireNonNull((Object)namespaced, "namespaced")).namespace(), value);
    }
    
    @NotNull
    default Key key(@KeyPattern.Namespace @NotNull final String namespace, @KeyPattern.Value @NotNull final String value) {
    ...
    default OptionalInt checkNamespace(@NotNull final String namespace) {
        Objects.requireNonNull((Object)namespace, "namespace");

...
import cc.dreamcode.antylogout.libs.net.kyori.adventure.util.IntFunction2;
import java.util.function.Function;
import java.util.regex.Pattern;
import java.util.Spliterators;
import java.util.Spliterator;
import java.util.function.Supplier;
import cc.dreamcode.antylogout.libs.net.kyori.adventure.util.ForwardingIterator;
...
import cc.dreamcode.antylogout.libs.net.kyori.adventure.text.format.ShadowColor;
import java.util.Collection;
import java.util.ArrayList;
import cc.dreamcode.antylogout.libs.net.kyori.adventure.util.MonkeyBars;
import java.util.Iterator;
import cc.dreamcode.antylogout.libs.net.kyori.adventure.text.event.HoverEvent;
import cc.dreamcode.antylogout.libs.net.kyori.adventure.translation.Translatable;
...
import cc.dreamcode.antylogout.libs.net.kyori.adventure.text.format.StyleGetter;
...
public interface Component extends ComponentBuilderApplicable, ComponentLike, Examinable, HoverEventSource<Component>, StyleGetter, StyleSetter<Component>
{
    ...
    @Contract(value = "_, _ -> new", pure = true)
    @NotNull
    default <C> VirtualComponent virtual(@NotNull final Class<C> contextType, @NotNull final VirtualComponentRenderer<C> renderer) {
        Objects.requireNonNull((Object)contextType, "context type");
        Objects.requireNonNull((Object)renderer, "renderer");
        return VirtualComponentImpl.createVirtual(contextType, renderer);
    }
    
    @Contract(value = "_, _, _ -> new", pure = true)
    @NotNull
    default <C> VirtualComponent virtual(@NotNull final Class<C> contextType, @NotNull final VirtualComponentRenderer<C> renderer, @NotNull final Style style) {
        Objects.requireNonNull((Object)contextType, "context type");
        Objects.requireNonNull((Object)renderer, "renderer");
        return VirtualComponentImpl.createVirtual(contextType, renderer, (List<? extends ComponentLike>)Collections.emptyList(), style);
    }
    
    @Contract(value = "_, _, _ -> new", pure = true)
    @NotNull
    default <C> VirtualComponent virtual(@NotNull final Class<C> contextType, @NotNull final VirtualComponentRenderer<C> renderer, @NotNull final StyleBuilderApplicable... style) {
        Objects.requireNonNull((Object)contextType, "context type");
        Objects.requireNonNull((Object)renderer, "renderer");
        return VirtualComponentImpl.createVirtual(contextType, renderer, (List<? extends ComponentLike>)Collections.emptyList(), Style.style(style));
    }
    
    @Contract(value = "_, _, _ -> new", pure = true)
    @NotNull
    default <C> VirtualComponent virtual(@NotNull final Class<C> contextType, @NotNull final VirtualComponentRenderer<C> renderer, @NotNull final Iterable<StyleBuilderApplicable> style) {
        Objects.requireNonNull((Object)contextType, "context type");
        Objects.requireNonNull((Object)renderer, "renderer");
        return VirtualComponentImpl.createVirtual(contextType, renderer, (List<? extends ComponentLike>)Collections.emptyList(), Style.style(style));
    }
    ...
    @Contract(pure = true)
    @NotNull
    default Component append(@NotNull final ComponentLike... components) {
        if (components.length == 0) {
            return this;
        }
        final List<ComponentLike> newChildren = (List<ComponentLike>)new ArrayList(components.length + this.children().size());
        newChildren.addAll((Collection)this.children());
        Collections.addAll((Collection)newChildren, (Object[])components);
        return this.children(newChildren);
    }
    
    @Contract(pure = true)
    @NotNull
    default Component append(@NotNull final List<? extends ComponentLike> components) {
        ...
        final List<ComponentLike> newChildren = (List<ComponentLike>)new ArrayList(components.size() + this.children().size());
        newChildren.addAll((Collection)this.children());
        newChildren.addAll((Collection)components);
        return this.children(newChildren);
    }
    ...
    @Contract(pure = true)
    @NotNull
    default Component shadowColor(@Nullable final ARGBLike argb) {
        return this.style(this.style().shadowColor(argb));
    }
    
    @Contract(pure = true)
    @NotNull
    default Component shadowColorIfAbsent(@Nullable final ARGBLike argb) {

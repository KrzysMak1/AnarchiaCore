...
import cc.dreamcode.antylogout.libs.net.kyori.adventure.internal.properties.AdventureProperties;
...
import cc.dreamcode.antylogout.libs.net.kyori.adventure.internal.Internals;
import org.jetbrains.annotations.Nullable;
import cc.dreamcode.antylogout.libs.net.kyori.adventure.util.Nag;
...
class TextComponentImpl extends AbstractComponent implements TextComponent
{
    ...
    TextComponent create0(@NotNull final List<? extends ComponentLike> children, @NotNull final Style style, @NotNull final String content) {

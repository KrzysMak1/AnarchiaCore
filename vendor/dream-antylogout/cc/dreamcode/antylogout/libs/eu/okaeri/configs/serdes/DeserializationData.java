...
public class DeserializationData
{
    ...
    public <T> Set<T> getValueAsSet(@NonNull final Class<T> setValueType) {
        if (setValueType == null) {
            throw new NullPointerException("setValueType is marked non-null but is null");
        }
        return this.getAsSet("$$__value__$$", setValueType);
    }
    ...
    public Object getRaw(@NonNull final String key) {
        ...
        if (!this.isValue() && "$$__value__$$".equals((Object)key)) {
            return this.asMap();
        }
    ...
    public <T> T getDirect(@NonNull final String key, @NonNull final GenericsDeclaration genericType) {
        ...
        return this.configurer.resolveType(object, null, genericType.getType(), genericType, SerdesContext.of(this.configurer));
    }
    ...
    public <T> Set<T> getAsSet(@NonNull final String key, @NonNull final Class<T> setValueType) {
        if (key == null) {
            throw new NullPointerException("key is marked non-null but is null");
        }
        if (setValueType == null) {
        ...
        final GenericsDeclaration genericType = GenericsDeclaration.of(Set.class, (List<Object>)Collections.singletonList((Object)setValueType));

package cc.dreamcode.antylogout.libs.eu.okaeri.injector;
...
import cc.dreamcode.antylogout.libs.eu.okaeri.injector.exception.InjectorException;
...
public interface Injector
{
    ...
    default <T> Injector registerExclusive(@NonNull final String name, @NonNull final T object) throws InjectorException {
        ...
        this.removeIf((Predicate<Injectable>)(injectable -> name.equals((Object)injectable.getName()) && (type.isAssignableFrom(injectable.getType()) || injectable.getType().isAssignableFrom(type))));
    ...
    default <T> Injector registerExclusive(@NonNull final String name, @NonNull final T object, @NonNull final Class<T> type) throws InjectorException {
        ...
        this.removeIf((Predicate<Injectable>)(injectable -> name.equals((Object)injectable.getName()) && type.isAssignableFrom(injectable.getType())));
    ...
    default <T> Optional<? extends Injectable<T>> getInjectable(@NonNull final String name, @NonNull final Class<T> type) {
        ...
        final Injectable<T> value = (Injectable<T>)this.getInjectableExact(name, (Class<Object>)type).orElse((Object)null);
        if (value == null && !"".equals((Object)name)) {

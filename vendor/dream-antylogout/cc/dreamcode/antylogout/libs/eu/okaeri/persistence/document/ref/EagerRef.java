...
{
    protected EagerRef(@NonNull final PersistencePath id, @NonNull final PersistencePath collection, @NonNull final Class<? extends Document> valueType, final T value, final boolean fetched, @NonNull final DocumentPersistence persistence) {

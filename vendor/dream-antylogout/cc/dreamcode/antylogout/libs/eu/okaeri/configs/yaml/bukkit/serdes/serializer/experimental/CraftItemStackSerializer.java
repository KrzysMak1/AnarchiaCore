package cc.dreamcode.antylogout.libs.eu.okaeri.configs.yaml.bukkit.serdes.serializer.experimental;
...
public class CraftItemStackSerializer implements ObjectSerializer<ItemStack>
{
    ...
    public static boolean compareDeep(@NonNull final ItemStack stack1, @NonNull final ItemStack stack2) {
        if (stack1 == null) {
        ...
        final YamlConfiguration config1 = new YamlConfiguration();
        config1.set("_", (Object)stack1);
        final YamlConfiguration config2 = new YamlConfiguration();
        config2.set("_", (Object)stack2);
        return config1.saveToString().equals((Object)config2.saveToString());
    }
    ...
    @Generated
    public CraftItemStackSerializer(final boolean verbose) {
        this.verbose = false;

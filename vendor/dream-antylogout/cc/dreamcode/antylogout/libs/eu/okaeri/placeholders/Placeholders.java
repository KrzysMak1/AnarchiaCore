...
import cc.dreamcode.antylogout.libs.eu.okaeri.placeholders.schema.resolver.PlaceholderResolver;
...
public class Placeholders
{
    ...
    public PlaceholderResolver getResolver(@NonNull final Object from, @Nullable final String param) {
        ...
        final Map<String, PlaceholderResolver> resolverMap = (Map<String, PlaceholderResolver>)this.resolvers.get((Object)fromClass);
        if (resolverMap != null) {
        ...
        final PlaceholderResolver resolver = this.findResolverOrNull(from, param);
        if (resolver != null) {
            return resolver;
        }
    ...
    public PlaceholderResolver findResolverOrNull(@NonNull final Object from, @Nullable final String param) {
        if (from == null) {
            throw new NullPointerException("from is marked non-null but is null");
        }
        for (final Class<?> potentialType : this.resolversOrdered) {
            ...
            final Map<String, PlaceholderResolver> resolverMap = (Map<String, PlaceholderResolver>)this.resolvers.get((Object)potentialType);
            final PlaceholderResolver resolver = (PlaceholderResolver)resolverMap.get((Object)param);
            if (resolver == null) {
                continue;
            }

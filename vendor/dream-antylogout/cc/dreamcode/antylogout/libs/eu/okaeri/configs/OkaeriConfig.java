...
import cc.dreamcode.antylogout.libs.eu.okaeri.configs.migrate.builtin.NamedMigration;
import lombok.Generated;
import cc.dreamcode.antylogout.libs.eu.okaeri.configs.annotation.Variable;
...
import cc.dreamcode.antylogout.libs.eu.okaeri.configs.exception.ValidationException;
...
import java.io.File;
import cc.dreamcode.antylogout.libs.eu.okaeri.configs.exception.InitializationException;
...
public abstract class OkaeriConfig
{
    ...
    public OkaeriConfig withConfigurer(@NonNull final Configurer configurer, @NonNull final OkaeriSerdesPack... serdesPack) {
        ...
        this.setConfigurer(configurer);
        final Stream stream = Arrays.stream((Object[])serdesPack);
        final Configurer configurer2 = this.getConfigurer();
        Objects.requireNonNull((Object)configurer2);
    ...
    public void set(@NonNull final String key, Object value) throws OkaeriException {
        ...
        final FieldDeclaration field = (FieldDeclaration)this.getDeclaration().getField(key).orElse((Object)null);
        if (field != null) {
    ...
    public <T> T get(@NonNull final String key, @NonNull final GenericsDeclaration generics) throws OkaeriException {
        ...
        final FieldDeclaration field = (FieldDeclaration)this.getDeclaration().getField(key).orElse((Object)null);
        if (field != null) {
            return this.getConfigurer().resolveType(field.getValue(), field.getType(), generics.getType(), generics, SerdesContext.of(this.configurer, field));
        }
        return this.getConfigurer().getValue(key, generics.getType(), null, SerdesContext.of(this.configurer));
    }

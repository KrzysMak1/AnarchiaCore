...
public class SerdesContext
{
    ...
    public <T extends Annotation> Optional<T> getConfigAnnotation(@NonNull final Class<T> type) {
        ...
        return (Optional<T>)((this.getConfigurer().getParent() == null) ? Optional.empty() : Optional.ofNullable((Object)this.getConfigurer().getParent().getClass().getAnnotation(type)));
    }
    ...
    public <T extends Annotation> Optional<T> getFieldAnnotation(@NonNull final Class<T> type) {
        ...
        return (Optional<T>)((this.getField() == null) ? Optional.empty() : this.getField().getAnnotation(type));
    }
    
    public <T extends SerdesContextAttachment> Optional<T> getAttachment(final Class<T> type) {
        final T attachment = (T)this.attachments.get((Object)type);
        return (Optional<T>)Optional.ofNullable((Object)attachment);
    }
    
    public <T extends SerdesContextAttachment> T getAttachment(final Class<T> type, final T defaultValue) {
        return (T)this.getAttachment(type).orElse((Object)defaultValue);
    }

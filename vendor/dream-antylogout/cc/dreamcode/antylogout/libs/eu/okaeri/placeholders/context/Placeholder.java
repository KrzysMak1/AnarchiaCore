...
import cc.dreamcode.antylogout.libs.eu.okaeri.placeholders.schema.meta.SchemaMeta;
import cc.dreamcode.antylogout.libs.eu.okaeri.placeholders.schema.resolver.PlaceholderResolver;
import cc.dreamcode.antylogout.libs.eu.okaeri.placeholders.schema.resolver.DefaultSchemaResolver;
    ...
    private String render(@Nullable Object object, @NonNull final MessageField field) {
        ...
        if (this.placeholders != null) {
            if (field.getSub() != null) {
                ...
                if (resolver == null) {
                    if (object.getClass().getAnnotation(cc.dreamcode.antylogout.libs.eu.okaeri.placeholders.schema.annotation.Placeholder.class) != null) {

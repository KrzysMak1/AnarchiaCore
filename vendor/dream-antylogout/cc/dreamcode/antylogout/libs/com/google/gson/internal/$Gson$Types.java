...
public final class $Gson$Types
{
    ...
    public static ParameterizedType newParameterizedTypeWithOwner(final Type ownerType, final Type rawType, final Type... typeArguments) {
        return (ParameterizedType)new ParameterizedTypeImpl(ownerType, rawType, typeArguments);
    }
    
    public static GenericArrayType arrayOf(final Type componentType) {
        return (GenericArrayType)new GenericArrayTypeImpl(componentType);
    }
    ...
    public static WildcardType subtypeOf(final Type bound) {
        ...
        return (WildcardType)new WildcardTypeImpl(upperBounds, $Gson$Types.EMPTY_TYPE_ARRAY);
    }
    ...
    public static WildcardType supertypeOf(final Type bound) {
        ...
        return (WildcardType)new WildcardTypeImpl(new Type[] { (Type)Object.class }, lowerBounds);
    }
    
    public static Type canonicalize(final Type type) {
        if (type instanceof Class) {
            final Class<?> c = (Class<?>)type;
            return (Type)(c.isArray() ? new GenericArrayTypeImpl(canonicalize((Type)c.getComponentType())) : c);
        }
        if (type instanceof ParameterizedType) {
            final ParameterizedType p = (ParameterizedType)type;
            return (Type)new ParameterizedTypeImpl(p.getOwnerType(), p.getRawType(), p.getActualTypeArguments());
        }
        if (type instanceof GenericArrayType) {
            final GenericArrayType g = (GenericArrayType)type;
            return (Type)new GenericArrayTypeImpl(g.getGenericComponentType());
        }
        if (type instanceof WildcardType) {
            final WildcardType w = (WildcardType)type;
            return (Type)new WildcardTypeImpl(w.getUpperBounds(), w.getLowerBounds());
        }
        return type;
    }
    ...
    public static Class<?> getRawType(final Type type) {
        ...
        if (type instanceof GenericArrayType) {
            ...
            return Array.newInstance((Class)getRawType(componentType), 0).getClass();
        }
    ...
    public static boolean equals(final Type a, final Type b) {
        ...
        if (a instanceof ParameterizedType) {
            ...
            return va.getGenericDeclaration() == vb.getGenericDeclaration() && va.getName().equals((Object)vb.getName());
        }
    }
    ...
    public static Type[] getMapKeyAndValueTypes(final Type context, final Class<?> contextRawType) {
        if (context == Properties.class) {
            return new Type[] { (Type)String.class, (Type)String.class };
        }
        ...
        return new Type[] { (Type)Object.class, (Type)Object.class };
    }
    
    public static Type resolve(final Type context, final Class<?> contextRawType, final Type toResolve) {
        return resolve(context, contextRawType, toResolve, (Map<TypeVariable<?>, Type>)new HashMap());
    }
    ...
    private static Type resolve(final Type context, final Class<?> contextRawType, Type toResolve, final Map<TypeVariable<?>, Type> visitedTypeVariables) {
        ...
        while (true) {
            while (toResolve instanceof TypeVariable) {
                ...
                final Type previouslyResolved = (Type)visitedTypeVariables.get((Object)typeVariable);
                if (previouslyResolved != null) {
                    return (previouslyResolved == Void.TYPE) ? toResolve : previouslyResolved;
                }
                visitedTypeVariables.put((Object)typeVariable, (Object)Void.TYPE);
                if (resolving == null) {
                ...
                if (toResolve == typeVariable) {
                    if (resolving != null) {
                        visitedTypeVariables.put((Object)resolving, (Object)toResolve);
                    }
                    return toResolve;
                }
            }
            if (toResolve instanceof Class && ((Class)toResolve).isArray()) {
                ...
                final Type componentType = (Type)original.getComponentType();
            ...
            if (toResolve instanceof GenericArrayType) {
                ...
                final Type newComponentType = resolve(context, contextRawType, componentType, visitedTypeVariables);
                toResolve = (Type)(equal(componentType, newComponentType) ? original2 : arrayOf(newComponentType));
                continue;
            }
            if (toResolve instanceof ParameterizedType) {
                ...
                toResolve = (Type)(changed ? newParameterizedTypeWithOwner(newOwnerType, original3.getRawType(), args) : original3);
                continue;
            }
            if (toResolve instanceof WildcardType) {
                ...
                if (originalLowerBound.length == 1) {
                    ...
                    if (lowerBound != originalLowerBound[0]) {
                        toResolve = (Type)supertypeOf(lowerBound);
                        continue;
                    }
                }
                    ...
                    if (upperBound != originalUpperBound[0]) {
                        toResolve = (Type)subtypeOf(upperBound);
                        continue;
                    }
                }
                toResolve = (Type)original4;
            }
            continue;
        }
    }
    ...
    private static final class ParameterizedTypeImpl implements ParameterizedType, Serializable
    {
        ...
        public boolean equals(final Object other) {
            return other instanceof ParameterizedType && $Gson$Types.equals((Type)this, (Type)other);
        }
    ...
    private static final class GenericArrayTypeImpl implements GenericArrayType, Serializable
    {
        ...
        public boolean equals(final Object o) {
            return o instanceof GenericArrayType && $Gson$Types.equals((Type)this, (Type)o);
        }
    ...
    private static final class WildcardTypeImpl implements WildcardType, Serializable
    {
        ...
        public WildcardTypeImpl(final Type[] upperBounds, final Type[] lowerBounds) {
            ...
            if (lowerBounds.length == 1) {
                ...
                this.upperBound = (Type)Object.class;
            }
            else {
        ...
        @Override
        public boolean equals(final Object other) {
            return other instanceof WildcardType && $Gson$Types.equals((Type)this, (Type)other);
        }

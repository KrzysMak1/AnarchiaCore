...
public class JsonWriter implements Closeable, Flushable
{
    ...
    private JsonWriter open(final int empty, final char openBracket) throws IOException {
        this.beforeValue();
        this.push(empty);
        this.out.write((int)openBracket);
        return this;
    }
    ...
    private JsonWriter close(final int empty, final int nonempty, final char closeBracket) throws IOException {
        ...
        this.out.write((int)closeBracket);
        return this;
    }
    ...
    public JsonWriter value(final Number value) throws IOException {
        ...
        if (string.equals((Object)"-Infinity") || string.equals((Object)"Infinity") || string.equals((Object)"NaN")) {
            ...
            if (!isTrustedNumberType(numberClass) && !JsonWriter.VALID_JSON_NUMBER_PATTERN.matcher((CharSequence)string).matches()) {
                throw new IllegalArgumentException("String created by " + (Object)numberClass + " is not a valid JSON number: " + string);
            }
        }
        this.beforeValue();

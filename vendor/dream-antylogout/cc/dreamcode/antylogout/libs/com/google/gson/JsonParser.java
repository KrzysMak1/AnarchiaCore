...
public final class JsonParser
{
    ...
    public static JsonElement parseReader(final JsonReader reader) throws JsonIOException, JsonSyntaxException {
        ...
        try {
            ...
            throw new JsonParseException("Failed parsing JSON source: " + (Object)reader + " to Json", (Throwable)e);
        }
        catch (final OutOfMemoryError e2) {
            throw new JsonParseException("Failed parsing JSON source: " + (Object)reader + " to Json", (Throwable)e2);
        }
        finally {

...
import cc.dreamcode.antylogout.libs.com.google.gson.FieldAttributes;
import cc.dreamcode.antylogout.libs.com.google.gson.annotations.Expose;
import cc.dreamcode.antylogout.libs.com.google.gson.annotations.Until;
import cc.dreamcode.antylogout.libs.com.google.gson.annotations.Since;
...
import cc.dreamcode.antylogout.libs.com.google.gson.ExclusionStrategy;
...
public final class Excluder implements TypeAdapterFactory, Cloneable
{
    ...
    public Excluder withExclusionStrategy(final ExclusionStrategy exclusionStrategy, final boolean serialization, final boolean deserialization) {
        final Excluder result = this.clone();
        if (serialization) {
            (result.serializationStrategies = (List<ExclusionStrategy>)new ArrayList((Collection)this.serializationStrategies)).add((Object)exclusionStrategy);
        }
        if (deserialization) {
            (result.deserializationStrategies = (List<ExclusionStrategy>)new ArrayList((Collection)this.deserializationStrategies)).add((Object)exclusionStrategy);
        }
        return result;
    }

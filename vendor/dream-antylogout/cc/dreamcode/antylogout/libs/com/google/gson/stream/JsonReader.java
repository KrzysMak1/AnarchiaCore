...
public class JsonReader implements Closeable
{
    ...
    public void beginArray() throws IOException {
        ...
        throw new IllegalStateException("Expected BEGIN_ARRAY but was " + (Object)this.peek() + this.locationString());
    }
    ...
    public void endArray() throws IOException {
        ...
        throw new IllegalStateException("Expected END_ARRAY but was " + (Object)this.peek() + this.locationString());
    }
    ...
    public void beginObject() throws IOException {
        ...
        throw new IllegalStateException("Expected BEGIN_OBJECT but was " + (Object)this.peek() + this.locationString());
    }
    ...
    public void endObject() throws IOException {
        ...
        throw new IllegalStateException("Expected END_OBJECT but was " + (Object)this.peek() + this.locationString());
    }
    ...
    public String nextName() throws IOException {
        ...
        if (p == 14) {
            ...
            if (p != 13) {
                throw new IllegalStateException("Expected a name but was " + (Object)this.peek() + this.locationString());
            }
            result = this.nextQuotedValue('\"');
        }
        this.peeked = 0;
    ...
    public String nextString() throws IOException {
        ...
        if (p == 10) {
            ...
            if (p != 16) {
                throw new IllegalStateException("Expected a string but was " + (Object)this.peek() + this.locationString());
            }
    ...
    public boolean nextBoolean() throws IOException {
        ...
        throw new IllegalStateException("Expected a boolean but was " + (Object)this.peek() + this.locationString());
    }
    ...
    public void nextNull() throws IOException {
        ...
        throw new IllegalStateException("Expected null but was " + (Object)this.peek() + this.locationString());
    }
    ...
    public double nextDouble() throws IOException {
        ...
        if (p == 16) {
            ...
            throw new IllegalStateException("Expected a double but was " + (Object)this.peek() + this.locationString());
        }
        this.peeked = 11;
    ...
    public long nextLong() throws IOException {
        ...
        Label_0218: {
            if (p != 16) {
                ...
                throw new IllegalStateException("Expected a long but was " + (Object)this.peek() + this.locationString());
            }
            this.peekedString = new String(this.buffer, this.pos, this.peekedNumberLength);
            this.pos += this.peekedNumberLength;
        }
        ...
        if (p == 15) {
            ...
            Label_0269: {
                if (p != 16) {
                    ...
                    throw new IllegalStateException("Expected an int but was " + (Object)this.peek() + this.locationString());
                }
                this.peekedString = new String(this.buffer, this.pos, this.peekedNumberLength);
                this.pos += this.peekedNumberLength;
            }
    ...
    private void push(final int newTop) {
        if (this.stackSize == this.stack.length) {
            ...
            this.pathNames = (String[])Arrays.copyOf((Object[])this.pathNames, newLength);
        }
    ...
    private boolean fillBuffer(int minimum) throws IOException {
        ...
        if (this.limit != this.pos) {
            this.limit -= this.pos;
            System.arraycopy((Object)buffer, this.pos, (Object)buffer, 0, this.limit);
        }
        else {
            this.limit = 0;
        }

package cc.dreamcode.antylogout.libs.cc.dreamcode.utilities.bukkit.nbt;
...
{
    Map<String, String> getValues(@NonNull final Plugin plugin, @NonNull final ItemStack itemStack);
    
    Map<String, String> getValues(@NonNull final ItemStack itemStack);
    ...
    ItemStack setValue(@NonNull final Plugin plugin, @NonNull final ItemStack itemStack, @NonNull final String key, @NonNull final String value);
}

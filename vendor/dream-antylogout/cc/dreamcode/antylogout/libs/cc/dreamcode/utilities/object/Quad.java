...
public class Quad<A, B, C, D>
{
    ...
    public Quad<A, B, C, D> then(final Consumer<Quad<A, B, C, D>> after) {
    ...
    public String toString() {
        return "Quad(first=" + this.getFirst() + ", second=" + this.getSecond() + ", third=" + this.getThird() + ", fourth=" + this.getFourth() + ")";
    }

...
import cc.dreamcode.antylogout.libs.cc.dreamcode.command.suggestion.filter.SuggestionFilter;
import cc.dreamcode.antylogout.libs.cc.dreamcode.command.suggestion.supplier.SuggestionSupplier;
import cc.dreamcode.antylogout.libs.cc.dreamcode.command.result.ResultResolver;
import cc.dreamcode.antylogout.libs.cc.dreamcode.command.bind.BindResolver;
...
import cc.dreamcode.antylogout.libs.cc.dreamcode.command.handler.exception.InvalidSenderException;
import cc.dreamcode.antylogout.libs.cc.dreamcode.command.handler.exception.InvalidPermissionException;
import cc.dreamcode.antylogout.libs.cc.dreamcode.command.handler.exception.InvalidInputException;
import java.util.Optional;
import java.util.stream.Collectors;
import cc.dreamcode.antylogout.libs.cc.dreamcode.command.handler.exception.InvalidUsageException;
import java.util.Arrays;
import java.util.ArrayList;
import java.util.List;
import lombok.NonNull;
import cc.dreamcode.antylogout.libs.cc.dreamcode.command.suggestion.DefaultSuggestions;
import cc.dreamcode.antylogout.libs.cc.dreamcode.command.resolver.DefaultTransformers;
import java.util.HashMap;
import java.util.Map;
import cc.dreamcode.antylogout.libs.cc.dreamcode.command.handler.InvalidInputHandler;
import cc.dreamcode.antylogout.libs.cc.dreamcode.command.handler.InvalidUsageHandler;
...
import cc.dreamcode.antylogout.libs.cc.dreamcode.command.suggestion.SuggestionService;
import cc.dreamcode.antylogout.libs.cc.dreamcode.command.suggestion.SuggestionCache;
import cc.dreamcode.antylogout.libs.cc.dreamcode.command.result.ResultService;
import cc.dreamcode.antylogout.libs.cc.dreamcode.command.result.ResultCache;
import cc.dreamcode.antylogout.libs.cc.dreamcode.command.resolver.ResolverService;
import cc.dreamcode.antylogout.libs.cc.dreamcode.command.resolver.ResolverCache;
import cc.dreamcode.antylogout.libs.cc.dreamcode.command.bind.BindService;
import cc.dreamcode.antylogout.libs.cc.dreamcode.command.bind.BindCache;
...
public class CommandProviderImpl implements CommandProvider
{
    ...
    @Override
    public CommandProviderImpl register(@NonNull final CommandEntry commandEntry, @NonNull final CommandBase commandBase) {
        ...
        this.commandMap.put((Object)commandEntry.getName(), (Object)commandMeta);
        Arrays.stream((Object[])commandEntry.getAliases()).forEach(label -> this.commandMap.put((Object)label, (Object)commandMeta));
    ...
    @Override
    public CommandProviderImpl register(@NonNull final CommandEntry commandEntry, @NonNull final CommandBase commandBase, @NonNull final Object instance) {
        if (commandEntry == null) {
            throw new NullPointerException("commandEntry is marked non-null but is null");
        }
        if (commandBase == null) {
    ...
    @Override
    public CommandProviderImpl unregister(@NonNull final CommandEntry commandEntry) {
        if (commandEntry == null) {
            throw new NullPointerException("commandEntry is marked non-null but is null");
        }
        this.commandMap.remove((Object)commandEntry.getName());
        final Stream stream = Arrays.stream((Object[])commandEntry.getAliases());

...
import cc.dreamcode.antylogout.libs.cc.dreamcode.command.annotation.Sender;
...
import cc.dreamcode.antylogout.libs.cc.dreamcode.utilities.option.Option;
import java.util.Optional;
import cc.dreamcode.antylogout.libs.cc.dreamcode.command.annotation.OptArg;
import cc.dreamcode.antylogout.libs.cc.dreamcode.command.annotation.Args;
...
public class CommandPathMeta
{
    ...
    public CommandPathMeta(@NonNull final CommandMeta commandMeta, @NonNull final Method method, @NonNull final String path, @NonNull final String description) {
        if (commandMeta == null) {
        ...
        this.argNames = (Map<Integer, ArgumentEntry>)new HashMap();
        this.argDisplayNames = (Map<Integer, ArgumentEntry>)new HashMap();
        ...
        for (int index2 = 0; index2 < this.method.getParameters().length; ++index2) {
            ...
            if (optionalArg.isPresent()) {
                ...
                this.argNames.put((Object)atomicNameIndex.get(), (Object)new ArgumentEntry(ArgumentEntry.Type.ARG, name));
                this.argDisplayNames.put((Object)atomicNameIndex.getAndIncrement(), (Object)new ArgumentEntry(ArgumentEntry.Type.ARG, "<" + name + ">"));
            }
            else {
                ...
                if (optionalArgs.isPresent()) {
                    ...
                    this.argClasses.put((Object)atomicNameIndex.get(), (Object)parameter.getType());
                    this.argNames.put((Object)atomicNameIndex.get(), (Object)new ArgumentEntry(ArgumentEntry.Type.ARGS, name2));
                    this.argDisplayNames.put((Object)atomicNameIndex.getAndIncrement(), (Object)new ArgumentEntry(ArgumentEntry.Type.ARGS, "(" + name2 + ")"));
                }
                else {
                    ...
                    if (optionalOptArg.isPresent()) {
                        ...
                        this.argNames.put((Object)atomicNameIndex.get(), (Object)new ArgumentEntry(ArgumentEntry.Type.OPTIONAL_ARG, name3));
                        this.argDisplayNames.put((Object)atomicNameIndex.getAndIncrement(), (Object)new ArgumentEntry(ArgumentEntry.Type.OPTIONAL_ARG, "[" + name3 + "]"));
                    }
                }
            }
        }
                ...
                if (Optional.class.isAssignableFrom(rawOptionalType) || Option.class.isAssignableFrom(rawOptionalType)) {
                    ...
                    if (parameterizedType.getActualTypeArguments().length == 1) {
                        ...
                        if (paramType instanceof Class) {
                            this.paramOptionalArgs.put((Object)index2, (Object)Duo.of((Class)paramType, true));
                            continue;
                        }
                    }
    ...
    private static Class<?> getRawType(@NonNull final Parameter parameter) {
        if (parameter == null) {
    ...
    public String getUsage() {
        ...
        listBuilder.add((Object)("/" + this.commandMeta.getCommandEntry().getName()));
        if (!this.path.isEmpty()) {
            listBuilder.addAll((Collection)Arrays.asList((Object[])this.path.split(" ")));
        }
        final Stream map = this.argDisplayNames.values().stream().map(ArgumentEntry::getValue);
    ...
    public List<String> getSuggestion(@NonNull final SuggestionService suggestionService, @NonNull final CommandInput commandInput) {
        ...
        this.paramMultiArgs.forEach((index, classType) -> {
            ...
            if (argumentParamLength >= min && argumentParamLength <= max) {
                final String displayName = ((ArgumentEntry)this.argDisplayNames.get((Object)(index - this.paramBinds.size()))).getValue();
        ...
        final ArgumentEntry argumentEntry = (ArgumentEntry)this.argNames.get((Object)argumentParamLength);
        final Optional<Completion> optionalCompletion = (Optional<Completion>)Arrays.stream((Object[])this.method.getAnnotationsByType((Class)Completion.class)).filter(completion -> Objects.equals((Object)completion.arg(), (Object)argumentEntry.getValue())).findAny();
        if (!optionalCompletion.isPresent()) {
            final ArgumentEntry commandDisplayArgument = (ArgumentEntry)this.argDisplayNames.get((Object)argumentParamLength);
            if (!commandDisplayArgument.getType().equals((Object)ArgumentEntry.Type.ARGS)) {
    ...
    @Generated
    public Map<Integer, ArgumentEntry> getArgNames() {
        return this.argNames;
    }
    
    @Generated
    public Map<Integer, ArgumentEntry> getArgDisplayNames() {

...
import cc.dreamcode.antylogout.libs.cc.dreamcode.menu.base.DreamMenuPaginated;
...
public class BukkitMenuPaginated implements DreamMenuPaginated<BukkitMenuPaginated, BukkitMenu, ItemStack, InventoryClickEvent, HumanEntity>
{
    ...
    public BukkitMenuPaginated dispose() {
        new ArrayList(this.bukkitMenuMap.values()).stream().filter(Objects::nonNull).forEach(BukkitMenu::dispose);

...
public interface CommandProvider
{
    ...
    CommandProviderImpl register(@NonNull final CommandEntry commandEntry, @NonNull final CommandBase commandBase);
    
    CommandProviderImpl register(@NonNull final CommandEntry commandEntry, @NonNull final CommandBase commandBase, @NonNull final Object instance);
    
    CommandProviderImpl unregister(@NonNull final CommandEntry commandEntry);

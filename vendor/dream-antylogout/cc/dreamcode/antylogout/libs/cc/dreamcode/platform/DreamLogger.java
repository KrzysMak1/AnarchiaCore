package cc.dreamcode.antylogout.libs.cc.dreamcode.platform;
...
public interface DreamLogger
{
    ...
    public static class Builder
    {
        ...
        public Builder() {
            this.meta = (Map<String, Object>)new TreeMap();
            this.footer = (List<String>)new ArrayList();
        }
        ...
        public Builder meta(final String name, final Object value) {
            this.meta.put((Object)name, value);
            return this;
        }
        ...
        public String build() {
            ...
            if (!this.meta.isEmpty()) {
                metaBuilder.append(" { ");
                metaBuilder.append((String)this.meta.entrySet().stream().map(entry -> {
                    Object rendered = entry.getValue();
                    if (rendered instanceof String) {
                        rendered = "'" + rendered + "'";
                    }
                    return (String)entry.getKey() + " = " + rendered;

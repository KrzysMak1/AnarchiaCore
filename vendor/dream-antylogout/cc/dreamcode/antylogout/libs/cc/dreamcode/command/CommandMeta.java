...
public class CommandMeta
{
    ...
    public CommandMeta(@NonNull final SuggestionService suggestionService, @NonNull final ResolverService resolverService, @NonNull final CommandEntry commandEntry, @NonNull final CommandBase commandBase, @NonNull final Object commandInstance) {
    ...
    public boolean equals(final Object o) {
        ...
        final Object this$commandEntry = this.getCommandEntry();
        final Object other$commandEntry = other.getCommandEntry();
        Label_0078: {
            if (this$commandEntry == null) {
                if (other$commandEntry == null) {
                    break Label_0078;
                }
            }
            else if (this$commandEntry.equals(other$commandEntry)) {
                break Label_0078;
            }
            return false;
        }
    ...
    public int hashCode() {
        ...
        final Object $commandEntry = this.getCommandEntry();
        result = result * 59 + (($commandEntry == null) ? 43 : $commandEntry.hashCode());

...
public final class StringUtil
{
    ...
    public static String replace(@NonNull final String text, @NonNull final Map<String, Object> placeholders) {
        ...
        return replace(text, Locale.forLanguageTag("pl"), placeholders);
    }
    
    public static String replace(@NonNull final String text, @NonNull final Locale locale, @NonNull final Map<String, Object> placeholders) {
        if (text == null) {
            throw new NullPointerException("text is marked non-null but is null");
        }
        if (locale == null) {

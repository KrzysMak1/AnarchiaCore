...
public final class ComponentService
{
    ...
    public ComponentService(final Injector injector) {
        this.classResolvers = (List<ComponentClassResolver>)new ArrayList();
        this.methodResolvers = (List<ComponentMethodResolver>)new ArrayList();
        this.debug = true;
    ...
    public void registerResolver(@NonNull final Class<? extends ComponentClassResolver> classResolver) {
        ...
        this.classResolvers.add((Object)componentClassResolver);
    }
    ...
    public void registerMethodResolver(@NonNull final Class<? extends ComponentMethodResolver> methodResolver) {
        ...
        this.methodResolvers.add((Object)componentMethodResolver);
    }
    ...
    public <T> void registerComponent(@NonNull final Class<T> componentClass, final Consumer<T> consumer) {
        try {
            ...
            final AtomicReference<ComponentClassResolver> reference = (AtomicReference<ComponentClassResolver>)new AtomicReference((Object)this.defaultClassResolver);
            for (final ComponentClassResolver classResolver : this.classResolvers) {
                if (classResolver.isAssignableFrom(componentClass)) {
                    reference.set((Object)classResolver);
                }
            }
            final T t = ((ComponentClassResolver)reference.get()).register(this.injector, componentClass, this.debug);
            if (consumer != null) {

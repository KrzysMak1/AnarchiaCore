package cc.dreamcode.antylogout.libs.cc.dreamcode.menu.bukkit.base;

import lombok.Generated;
import cc.dreamcode.antylogout.libs.cc.dreamcode.menu.utilities.MenuUtil;
...
import cc.dreamcode.antylogout.libs.cc.dreamcode.menu.bukkit.holder.DefaultMenuHolder;
import org.bukkit.event.inventory.InventoryClickEvent;
import org.bukkit.inventory.ItemStack;
import cc.dreamcode.antylogout.libs.cc.dreamcode.menu.base.DreamMenu;
...
public final class BukkitMenu implements DreamMenu<BukkitMenu, BukkitMenuPaginated, ItemStack, InventoryClickEvent, DefaultMenuHolder, HumanEntity>
{
    ...
    private final boolean colorizePlaceholders;
    ...
    public BukkitMenu(@NonNull final InventoryType inventoryType, @NonNull final String title, final int page) {
        ...
        this.page = page;
        this.inventory = Bukkit.createInventory((InventoryHolder)this.defaultMenuHolder, this.inventoryType, StringColorUtil.fixColor(title, (Map<String, Object>)new MapBuilder<String, Integer>().put("page", page).build(), false));
    }
    ...
    public BukkitMenu(@NonNull final InventoryType inventoryType, @NonNull final String title, @NonNull final Map<String, Object> placeholders, final int page) {
        ...
        this.page = page;
        this.inventory = Bukkit.createInventory((InventoryHolder)this.defaultMenuHolder, this.inventoryType, StringColorUtil.fixColor(title, (Map<String, Object>)new MapBuilder<String, Integer>().put("page", page).putAll((java.util.Map<? extends String, ? extends Integer>)placeholders).build(), true));
    }
    
    public BukkitMenu(@NonNull final InventoryType inventoryType, @NonNull final String title, @NonNull final Map<String, Object> placeholders, final int page, final boolean colorizePlaceholders) {
        this.cancelInventoryClick = true;
        this.disposeWhenClose = false;
        if (inventoryType == null) {
            throw new NullPointerException("inventoryType is marked non-null but is null");
        ...
        this.page = page;
        this.inventory = Bukkit.createInventory((InventoryHolder)this.defaultMenuHolder, this.inventoryType, StringColorUtil.fixColor(title, (Map<String, Object>)new MapBuilder<String, Integer>().put("page", page).putAll((java.util.Map<? extends String, ? extends Integer>)placeholders).build(), colorizePlaceholders));
    }
    ...
    public BukkitMenu(@NonNull final String title, final int rows, final int page) {
        ...
        this.colorizePlaceholders = false;
        this.page = page;
        this.inventory = Bukkit.createInventory((InventoryHolder)this.defaultMenuHolder, this.size, StringColorUtil.fixColor(title, (Map<String, Object>)new MapBuilder<String, Integer>().put("page", page).build(), false));
    }
    ...
    public BukkitMenu(@NonNull final String title, @NonNull final Map<String, Object> placeholders, final int rows, final int page) {
        ...
        this.colorizePlaceholders = true;
        this.page = page;
        this.inventory = Bukkit.createInventory((InventoryHolder)this.defaultMenuHolder, this.size, StringColorUtil.fixColor(title, (Map<String, Object>)new MapBuilder<String, Integer>().put("page", page).putAll((java.util.Map<? extends String, ? extends Integer>)placeholders).build(), true));
    }
    
    public BukkitMenu(@NonNull final String title, @NonNull final Map<String, Object> placeholders, final int rows, final int page, final boolean colorizePlaceholders) {
        this.cancelInventoryClick = true;
        this.disposeWhenClose = false;
        if (title == null) {
            throw new NullPointerException("title is marked non-null but is null");
        ...
        this.colorizePlaceholders = colorizePlaceholders;
        this.page = page;
        this.inventory = Bukkit.createInventory((InventoryHolder)this.defaultMenuHolder, this.size, StringColorUtil.fixColor(title, (Map<String, Object>)new MapBuilder<String, Integer>().put("page", page).putAll((java.util.Map<? extends String, ? extends Integer>)placeholders).build(), colorizePlaceholders));
    }
    ...
    @Generated
    public boolean isColorizePlaceholders() {
        return this.colorizePlaceholders;
    }

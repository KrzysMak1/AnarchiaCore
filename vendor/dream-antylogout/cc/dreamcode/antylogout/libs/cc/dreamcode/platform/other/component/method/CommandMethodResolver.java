package cc.dreamcode.antylogout.libs.cc.dreamcode.platform.other.component.method;
...
import cc.dreamcode.antylogout.libs.cc.dreamcode.platform.other.component.annotation.SingleCommand;
import cc.dreamcode.antylogout.libs.cc.dreamcode.platform.component.ComponentMethodResolver;
    ...
    public void apply(@NonNull final Injector injector, @NonNull final SingleCommand singleCommand, @NonNull final Method method, @NonNull final Object instance) {
        ...
        final CommandBase commandBase = new CommandBase() {
            ...
            public List<CommandPathMeta> getCommandPaths(@NonNull final CommandMeta commandMeta) {
                ...
                final List<CommandPathMeta> commandPathMetas = (List<CommandPathMeta>)new ArrayList();
                for (final String path : executor.path()) {
                    commandPathMetas.add((Object)new CommandPathMeta(commandMeta, method, path, executor.description()));
                }
